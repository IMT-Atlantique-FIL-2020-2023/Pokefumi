...
#### 1.6.1.2. Pourquoi s'embêter avec Nx ?
...
#### 1.8.1.2. Executer les tests d'intégration sans API Gateway avec Jest
...
### 1.11.3. Meilleur gestion des erreurs
